...
class AWSTranscriptProcessor:
    ...
    def __init__(self):
        ...
        self.batch_size = 10  # Larger batches on AWS
        self.api_delay = 0.1  # Small delay to respect rate limits
    ...
    def _init_clients(self):
        ...
        try:
            ...
            logger.info(f"📊 Current vectors in collection: {collection_info.points_count}")
    ...
    def get_all_metadata(self) -> List[Dict]:
        ...
        try:
            ...
            metadata_list.sort(key=lambda x: (x.get('season', 0), x.get('episode_number', '0')))
